...
import { PruebaDirectoIntentoHoyPage } from './prueba-directo-intento-hoy/prueba-directo-intento-hoy.page';

@Component({
  selector: 'app-prueba-directo-hoy',
  templateUrl: './prueba-directo-hoy.component.html',
  styleUrls: ['./prueba-directo-hoy.component.scss'],
})
export class PruebaDirectoHoyComponent implements OnInit {

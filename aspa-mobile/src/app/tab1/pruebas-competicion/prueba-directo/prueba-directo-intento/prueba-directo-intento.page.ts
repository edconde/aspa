...
@Component({
  selector: 'app-prueba-directo-intento',
  templateUrl: './prueba-directo-intento.page.html',
  styleUrls: ['./prueba-directo-intento.page.scss'],
})
export class PruebaDirectoIntentoPage implements OnInit {

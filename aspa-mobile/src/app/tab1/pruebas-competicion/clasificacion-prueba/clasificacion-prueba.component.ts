...
import { MarcasModalPage } from './marcas-modal/marcas-modal.page';
...
@Component({
  selector: 'app-clasificacion-prueba',
  templateUrl: './clasificacion-prueba.component.html',
  styleUrls: ['./clasificacion-prueba.component.scss'],
})
export class ClasificacionPruebaComponent implements OnInit {

...
(1,'admin@fga.com','admin000','Admin','Admin','43567565T','666666666','ADMIN','NIII','ADMIN'),
(2,'econde@fga.com','prueba123','Edgar','Conde Nóvoa','48468376H','663377221','JUEZ','NI','ECN160693'),
(3,'rperez@fga.com','prueba123','Raquel','Pérez García','444334223P','674665863','JUEZ','JAUT','RPP121193'),
(4,'jmartinez@fga.com','prueba123','Jose Manuel','Martínez Martínez','34985672J','622141353','JUEZ','NI','JMM100268'),
(5,'amartinez@fga.com','prueba123','Adrián','Martínez Pérez','444333681M','695823224','JUEZ','JAUT','AMP100268'),
(6,'pperez@fga.com','prueba123','Pilar','Pérez Conde','323434998B','622354887','JUEZ','JAUT','PPC100268'),
(7,'edominguez@fga.com','prueba123','Estela','Domínguez Ramos','36454876V','699854223','JUEZ','NIII','EDR100268'),
(8,'jcastro@fga.com','prueba123','Javier','Castro Novelle','39902313S','660023245','JUEZ','JAUT','JCV100268'),
(9,'ofortes@fga.com','prueba123','Óscar','Fortes Estévez','47782321Q','642001548','JUEZ','NI','OFE100268'),
(10,'llores@fga.com','prueba123','Leticia','Lores Docasar','37225335H','68450328','JUEZ','NI','LLD100268'),
(11,'mrodriguez@fga.com','prueba123','Manuel','Rodríguez Santos','36235634G','650226554','JUEZ','NI','MRS100268'),
(12,'ecovas@fga.com','prueba123','Elena','Covas Vázquez','43454568R','625440226','JUEZ','NII','ECV100268'),
(13,'slago@fga.com','prueba123','Sara Lago Piñeiro','Admin','43534435F','665441008','JUEZ','NII','SLP100268'),
(14,'alopez@fga.com','prueba123','Alberto','López Carvajal','43735815T','675485665','JUEZ','NII','ALC100268'),
(15,'niglesias@fga.com','prueba123','Natalia','Iglesias González','43546455W','687405475','JUEZ','NI','NIG100268');
...
(1,'APF10031978','apf@fga.com','prueba123','Adolfo','Pérez Fernández','1978-03-19',0,'14567789A','663344981',2),
(2,'PLR24041983','plr@fga.com','prueba123','Pedro','Lorenzo Riveiros','1983-03-19',0,'24567789B','663344982',2),
(3,'FPM22021975','fpm@fga.com','prueba123','Fabián','Pérez Martínez','1975-03-19',0,'34567789C','663344983',2),
(4,'MCI12061977','mci@fga.com','prueba123','Manuel','Cruz Mahia','1977-03-19',0,'44567789D','663344984',2),
(5,'MRR23091991','mrr@fga.com','prueba123','Marco Antonio','Rodríguez Rodríguez','1991-03-19',0,'54567789E','663344985',2),
(6,'RPP03051991','rpp@fga.com','prueba123','Rubén','Pérez Pérez','1991-03-19',0,'64567789F','663344986',1),
(7,'DAD12011988','dad@fga.com','prueba123','David','Álvarez Del Pino','1988-03-19',0,'74567789G','663344987',1),
(8,'AYB12121983','ayb@fga.com','prueba123','Álvaro','Yanes Basanta','1983-03-19',0,'84567789H','663344988',1),
(9,'ECN16061993','ecn@fga.com','prueba123','Edgar','Conde Nóvoa','1993-06-16',0,'35267789I','663344989',1),
(10,'MAV16061996','mav@fga.com','prueba123','Martín','Álvarez Varela','1996-06-16',0,'45367789I','663344989',1),
(11,'CGD16061998','cgd@fga.com','prueba123','Cristian','García Domínguez','1998-06-16',0,'44467789I','663344989',3),
(12,'GMT16062000','gmt@fga.com','prueba123','Guillermo','Moure Terradillos','2000-06-16',0,'66567789I','663344989',4),
(13,'APP16062001','app@fga.com','prueba123','Alejandro','Pérez Pérez','2001-06-16',0,'14567789I','663344989',3),
(14,'DCS16062002','dcs@fga.com','prueba123','Diego','Cebreiros Sotillo','2002-06-16',0,'24567789I','663344989',4),
(15,'JGG16062003','jgg@fga.com','prueba123','Jacobo','González González','2003-06-16',0,'34567789I','663344989',4),
(16,'DFC16062004','dfc@fga.com','prueba123','Diego','Fernández Cortés','2004-06-16',0,'44567789I','663344989',4),
(17,'MSS16062006','mss@fga.com','prueba123','Martín','Suárez Suárez','2006-06-16',0,'54567789I','663344989',3),
(18,'CNB16062008','cnb@fga.com','prueba123','Carlos','Noguerol Barrenechea','2008-06-16',0,'64567789I','663344989',3),
(19,'IFL16062009','ifl@fga.com','prueba123','Ignacio','Fernández López','2009-06-16',0,'74567789I','663344989',3),
(20,'DNB16062010','dnb@fga.com','prueba123','Diego','Nóvoa Blanco','2010-06-16',0,'84567789I','663344989',4),
(21,'RSC16061993','rsc@fga.com','prueba123','Raquel','Seixas Corral','1993-06-16',1,'44558889I','663344989',4),
(22,'XCG16061998','xcg@fga.com','prueba123','Xiana','Cid González','1998-06-16',1,'54561189I','663344989',3),
(23,'MED16061999','med@fga.com','prueba123','María','Estévez Domarco','2008-06-16',1,'64564259I','663344989',3),
(24,'PGD16062000','pgd@fga.com','prueba123','Paula','González Diéguez','2009-06-16',1,'74112789I','663344989',3),
(25,'MSC16062004','msc@fga.com','prueba123','Marta','Seixas Corral','2010-06-16',1,'84667789I','663344989',4);

INSERT INTO `competicion` (`idcompeticion`,`nombre`,`fecha`,`lugar`) VALUES (1,'XII Copa Diputación','2019-03-29','Ourense');
INSERT INTO `competicion` (`idcompeticion`,`nombre`,`fecha`,`lugar`) VALUES (2,'XVI Copa Galicia',CURRENT_DATE(),'Ourense');
INSERT INTO `competicion` (`idcompeticion`,`nombre`,`fecha`,`lugar`) VALUES (3,'IV Trofeo Aurum',CURRENT_DATE()+1,'Ourense');
...
(2,'2019-03-29','2019-03-29 09:40:00','2019-03-29 09:50:00','2019-03-29 10:00:00',1,1,117,0,0,0,1),
(3,CURRENT_DATE(),DATEADD('MINUTE',10, NOW()),DATEADD('MINUTE',20, NOW()),DATEADD('MINUTE',30, NOW()),2,1,189,3,3,8,0),
(4,CURRENT_DATE(),DATEADD('MINUTE',10, NOW()),DATEADD('MINUTE',20, NOW()),DATEADD('MINUTE',30, NOW()),2,1,117,0,0,0,0),
(5,CURRENT_DATE()+1,DATEADD('MINUTE',1450, NOW()),DATEADD('MINUTE',1460, NOW()),DATEADD('MINUTE',1470, NOW()),3,1,189,3,3,8,0),
(6,CURRENT_DATE()+1,DATEADD('MINUTE',1450, NOW()),DATEADD('MINUTE',1460, NOW()),DATEADD('MINUTE',1470, NOW()),3,1,117,0,0,0,0);
...
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (20,24,2,1,8);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (21,25,2,1,9);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (22,1,3,1,1);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (23,2,3,1,2);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (24,3,3,1,3);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (25,4,3,1,4);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (26,5,3,1,5);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (27,6,3,1,6);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (28,7,3,1,7);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (29,8,3,1,8);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (30,21,3,1,9);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (31,22,3,1,10);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (32,23,3,1,11);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (33,24,3,1,12);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (34,25,3,1,13);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (35,1,4,1,1);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (36,3,4,1,2);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (37,4,4,1,3);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (38,2,4,1,4);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (39,21,4,1,5);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (40,22,4,1,6);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (41,24,4,1,8);
INSERT INTO `inscripcion` (`idinscripcion`,`atleta_idatleta`,`prueba_idprueba`,`presentado`,`dorsal`) VALUES (42,25,4,1,9);
